...
#ifndef DOUBLE_LIST_TESTER_H    // include guards
...
class Double_list_tester:public Tester< Double_list<Object> > {
	using Tester< Double_list<Object> >::object;
	using Tester< Double_list<Object> >::command;

	public:
		Double_list_tester( Double_list<Object> *obj = 0 ):Tester< Double_list<Object> >( obj ) {
			// empty
		}
...
template <typename Object>
void Double_list_tester<Object>::process() {
	if ( command == "size" ) {
		...
		Double_node<Object> *actual_head = object->head();
		...
		if ( actual_head == 0 ) {
			...
			Double_node_tester<Object> tester( actual_head );
		...
		Double_node<Object> *actual_tail = object->tail();
		...
		if ( actual_tail == 0 ) {
			...
			Double_node_tester<Object> tester( actual_tail );
		...
		Object actual_popped_element = object->pop_back();
		...
		Double_list<Object> *new_object = new Double_list<Object>();

		*new_object = *(object);

		std::cout << "Okay" << std::endl;

		Double_list_tester<Object> tester( new_object );
